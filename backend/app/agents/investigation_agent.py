...
class InvestigationAgent:
    ...
    pore saturation shifts, and regional cluster agreement.
    """
    ...
    async def investigate(
        ...
        system_prompt = (
            ...
            "You evaluate factor deltas, precipitation surges, and pore saturation transitions. "
            "Every explanation must be grounded strictly in chronological data."
        )

        user_prompt = question or f"Investigate recent risk changes and triggers at {loc.get('name')}."
